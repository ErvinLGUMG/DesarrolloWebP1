...
<th colspan="3" style="text-align:center">Eliminar Libro</th>
<tr>
    <td colspan="2">

        <form method="GET" action="{{ route('books.eliminar') }}" class="needs-validation" novalidate>
            @csrf
            <div class="form-row">
                <div class="col-md-4"></div>
                <div class="col-md-4" style="text-align:center">
                    <label for="validationCustom02">Cod. de Libro</label>
